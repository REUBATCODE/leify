                ...
                <form method="POST" action="{{ route('artists.store') }}" class="mt-8 max-w-md mx-auto">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button>
                                <span class="ml-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" type = "submit">
                                    Register
                                </span>
                            </button>
                        </div>
