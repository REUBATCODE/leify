                    ...
                    <tbody>
                        ...
                        <tr class="text-center bg-white border-b  dark:border-gray-700">
                            ...
                            <td>
                                ...
                                <a class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-red-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800" href="{{ route('artists.view', $artist) }}">Eliminar</a>
                            </td>
                        </tr>
                        @endforeach
